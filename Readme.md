...
* **Neural TTS:** Integrates `edge-tts` for natural-sounding "Christopher" (US English) voice, avoiding robotic audio.
...
1. **Prepare your input:**
    Create a file named `words.txt` in the root directory. Add one word per line:
